        ...
        <div class="sm:w-1/5 min-w-min lg:w-64 h-full bg-white">
            <nav class="mt-10">
                <a class="flex items-center py-2 px-8 bg-gray-200 text-gray-700 border-r-4 border-gray-700" href="#">
                    ...
                    <span class="mx-4 font-medium text-sm lg:text-base">Home</span>
                </a>
                ...
                <a class="flex items-center mt-5 py-2 px-8 text-gray-600 border-r-4 border-white hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700" href="#">
                    ...
                    <span class="mx-4 font-medium text-sm lg:text-base">Pockets</span>
                </a>

                <a class="flex items-center mt-5 py-2 px-8 text-gray-600 border-r-4 border-white hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700" href="#">
                    <FontAwesomeIcon icon={faCoins} />

                    <span class="mx-4 font-medium text-sm lg:text-base">Budget</span>
                </a>
            </nav>
